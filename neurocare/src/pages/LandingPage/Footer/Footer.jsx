...
const Footer = () => {
  return (
    <section className="bg-black rounded-t-lg">
      <div className="grid">
        <img className="w-[150px] place-self-center   " src="../../../../src/assets/logo-hero-main.png" alt="" />
      </div>
      ...
      <div>
        <p className="text-white text-center md:pt-20 p-5">© 2025 NeuroCare || Stanley Amunze. All rights reserved.</p>
      </div>
    </section>
  );
};
