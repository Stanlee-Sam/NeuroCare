      ...
      <div className="glass">
        <div className="hero-top" >
          ...
          <div className="buttons">
            <button className="bg-[#77DD77] text-black-600 p-3 rounded-lg text-[10px] md:text-[15px] font-bold hover:bg-gray-100 transition">Sign up</button>
        ...
        <div>
          <div className = "banner ">
            ...
            <button className="bg-[#77DD77] text-black-600 p-3 rounded-lg text-[10px] md:text-[15px] font-bold hover:bg-gray-100 transition absolute bottom-[26%] left-[46%] text-md ">Get Started</button>
          </div>
          <div>
