        ...
        <div className="space-y-4">
          ...
          <div className="stats & log md:flex justify-evenly md:gap-2 space-y-4">
            <div className=" bg-[#608BC1] rounded-lg p-5 space-y-3">
              ...
              <p className="text-[10px] text-white ">What's your mood today?</p>
            ...
            <div className="grid md:grid-cols-2 gap-2 justify-evenly ">
              <div className="grid bg-white rounded-lg p-3  ">
                <h3 className="text-[15px] font-bold text-center">Current sentiment</h3>
              ...
              <div className="grid bg-white rounded-lg p-3">
                <h3 className="text-[15px] font-bold text-center">Most Frequent Mood</h3>
                <div className="flex justify-evenly items-center">
          ...
          <div className="calendar & recent activity">
            <div className="sentiment-calendar"></div>
